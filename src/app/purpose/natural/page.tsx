...
export default function NaturalPage() {
  return (
    <main className="min-h-screen">
      <Breadcrumb items={[{ name: "目的別" }, { name: "ナチュラル" }]} />
      {/* ===== Hero ===== */}
      ...
      {/* JSON-LD */}
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context": "https://schema.org", "@type": "FAQPage", "mainEntity": [{"@type": "Question", "name": "アートメイクだとバレませんか？", "acceptedAnswer": {"@type": "Answer", "text": "3D以上のストローク技法で、適切な色味・デザインを選べば、ほとんどの方が気づきません。施術直後は少し濃く見えますが、1〜2週間で自然に馴染みます。"}}, {"@type": "Question", "name": "どの技法が一番自然ですか？", "acceptedAnswer": {"@type": "Answer", "text": "4Dコンビネーション（毛並み+パウダー）が最もバランスが良く自然です。さらに究極の自然さを求めるなら7Dストロークがおすすめですが、対応クリニックは限られます。"}}, {"@type": "Question", "name": "施術直後は不自然に見えますか？", "acceptedAnswer": {"@type": "Answer", "text": "施術直後〜3日程度は色が濃く出るため、やや不自然に見えることがあります。1〜2週間で色が落ち着き、最終的な仕上がりは2回目の施術後1ヶ月程度で完成します。"}}, {"@type": "Question", "name": "自毛が少なくてもナチュラルに仕上がりますか？", "acceptedAnswer": {"@type": "Answer", "text": "はい、可能です。3Dストロークで自毛のような毛並みを描くことで、毛量が少ない部分も自然にカバーできます。眉毛の育毛剤との併用でさらに自然な仕上がりに。"}}, {"@type": "Question", "name": "ナチュラル仕上げの場合、持続期間は短くなりますか？", "acceptedAnswer": {"@type": "Answer", "text": "薄めの色で入れる分、濃い色よりも退色が早い傾向はあります。ただし1〜2年は持続し、リタッチで色を補充すれば美しい状態を維持できます。"}}]}) }} />
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context": "https://schema.org", "@type": "BreadcrumbList", "itemListElement": [{"@type": "ListItem", "position": 1, "name": "ホーム", "item": "https://artmake-hikaku-navi.com/"}, {"@type": "ListItem", "position": 2, "name": "ナチュラル", "item": "https://artmake-hikaku-navi.com/purpose/natural/"}]}) }} />
    </main>
  );
}
