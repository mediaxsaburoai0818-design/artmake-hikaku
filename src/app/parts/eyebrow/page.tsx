...
export const metadata: Metadata = {
  title: "眉毛アートメイクの料金・値段はいくら？【2026年】2D/3D/4Dの違いと検証済み院の実額比較",
  description:
    "眉毛アートメイクの料金・値段を検証済みの公式実額で比較（例: 2回40,000円〜113,800円・2026年6月12日確認・税込）。2D・3D・4Dの技法の違い、デザインの種類、ダウンタイム経過、後悔しない選び方まで完全ガイド。",
  keywords:
...
export default function EyebrowPage() {
  return (
    <main className="min-h-screen">
      <Breadcrumb items={[{ name: "部位別" }, { name: "眉毛" }]} />
      {/* ===== 1. Hero ===== */}
            ...
            {[
              {
                ...
                techniques: "2D / 3D / 4D / 7Dストローク®",
                price: "2回 90,000〜150,000円（ランク別）／1回 50,000〜80,000円 ※2026年6月12日公式確認・税込",
                retouch: "公式サイトで要確認",
                areas: "表参道・新宿ほか（院一覧は公式で要確認）",
                points: [
                  "累計23万件超の実績を公表する大手（当サイト検証値）",
                  "施術者ランク制で技術レベルを選べる（ノービス〜グランドマスター）",
                  "7Dストローク®で極細の毛並みを再現（累計23万件超の実績）",
                  "モニター価格あり（最大50%OFF）",
                ],
              },
              {
              ...
              },
              {
                ...
                price: "眉 初回132,000円（3回分・1回あたり44,000円）※2026年6月12日公式確認・税込",
                retouch: "33,000〜55,000円",
                areas: "有楽町（東京）",
                points: [
                  "3回セットで色素の定着を図る方式（指名料なしの明朗会計）",
                  "開院から10,000件以上の実績",
                  "皮膚科・形成外科の医師が在籍で安心",
                  "完全個室でプライバシーに配慮",
                ],
              },
              {
                ...
                techniques: "2D / 3D / 4D",
                price: "2回 40,000円（2D）／60,000円（3D）／70,000円（4D）※2026年6月12日公式確認・税込",
                retouch: "公式サイトで要確認",
                areas: "院情報は公式サイトで要確認",
                points: [
                  "技法別のシンプルな料金体系で、2回セットの入口価格が当サイト検証5院で最安クラス",
                  "指名料も1回1,500円と低め（2026年6月12日確認）",
                  "費用を抑えて眉アートメイクを始めたい方の第一候補",
                ],
              },
              {
                rank: 5,
                ...
                techniques: "毛並み / パウダー / ミックス（ランク制）",
                price: "1回 60,000〜80,000円（ランク別・銀座本院）／トップランク2回 150,000円 ※2026年6月12日公式確認・税込",
                retouch: "公式サイトで要確認",
                areas: "銀座ほか全国27院",
                points: [
                  "全国27院展開・ランク制。モニター利用で総額を抑えやすい（当サイト検証: 総額約93,500円〜）",
                  "指名料5,500〜11,000円と大手の中では低め",
                  "モニター条件はカウンセリングで要確認",
                ],
              },
            ].map((clinic) => (
              ...
              <tbody>
                {[
                  ...
                  },
                  {
                    clinic: "デイジー",
                    d2: "—",
                    d3: "natural brow 2回49,800円〜（福岡天神）",
                    d4: "dazzy Brow 2回113,800円（新宿）",
                    retouch: "要確認",
                  },
                  {
                    clinic: "クレアージュ",
      ...
      <Link href="/review/dazzy/" className="block bg-white rounded-lg p-4 shadow-sm hover:shadow-md transition border border-gray-100">
        ...
        <p className="font-semibold mt-1">DAZZY CLINIC（デイジー）の口コミ・料金</p>
      </Link>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context": "https://schema.org", "@type": "BreadcrumbList", "itemListElement": [{"@type": "ListItem", "position": 1, "name": "ホーム", "item": "https://artmake-hikaku.com/"}, {"@type": "ListItem", "position": 2, "name": "眉毛", "item": "https://artmake-hikaku.com/parts/eyebrow/"}]}) }} />
    </main>
  );
}
