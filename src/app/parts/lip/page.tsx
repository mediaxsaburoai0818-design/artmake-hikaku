...
export const metadata: Metadata = {
  title: "リップアートメイクの料金・値段はいくら？【2026年】検証済み院の実額とデザインの選び方",
  description:
    "リップアートメイクの料金・値段を検証済みの公式実額で解説（例: 1回55,000円〜・2回セット12万円等、2026年6月12日確認・税込）。フルリップ・グラデーションの施術方法、カラー選び、ダウンタイム、クリニックの選び方まで完全ガイド。",
  keywords:
    "リップアートメイク おすすめ,リップアートメイク,リップアートメイク 料金,リップアートメイク ダウンタイム,唇 アートメイク",
  openGraph: {
    title: "リップアートメイクの料金・値段はいくら？検証済み院の実額と選び方",
    description:
...
export default function LipPage() {
  return (
    <main className="min-h-screen">
      <Breadcrumb items={[{ name: "部位別" }, { name: "リップ" }]} />
      {/* ===== 1. Hero ===== */}
            ...
            {[
              {
                ...
                price: "1回 55,000〜65,000円（モニター40,000円〜）※2026年6月12日公式確認・税込",
                retouch: "公式サイトで要確認",
                areas: "表参道・新宿ほか（院一覧は公式で要確認）",
                points: [
                  "大手ならではの症例実績。ランク・指名料込みの総額で比較を",
              ...
              },
              {
                ...
                price: "dazzy Lip 2回120,000円・1回77,000円 ※2026年6月12日公式確認・税込",
                retouch: "公式サイトで要確認",
                areas: "新宿・札幌・福岡天神（3院）",
                points: [
              ...
              },
              {
                ...
                price: "初回198,000円（3回分）※2026年6月12日公式確認・税込",
                retouch: "公式サイトで要確認",
                areas: "有楽町（東京）",
                points: [
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mt-8 bg-gradient-to-br from-rose-500 to-pink-600 rounded-xl p-6 text-center text-white">
            ...
            <p className="text-sm opacity-90 mb-4 max-w-2xl mx-auto">
              リップを含む主要8クリニックの公式サイト実額を、指名料などを合算した「実際に払う総額」ベースでまとめています（税込・確認日付きの一次データ）。各院の料金をまとめて見比べたい方はこちら。
            </p>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context": "https://schema.org", "@type": "BreadcrumbList", "itemListElement": [{"@type": "ListItem", "position": 1, "name": "ホーム", "item": "https://artmake-hikaku.com/"}, {"@type": "ListItem", "position": 2, "name": "リップ", "item": "https://artmake-hikaku.com/parts/lip/"}]}) }} />
    </main>
  );
}
