...
export const metadata: Metadata = {
  ...
  description:
    "【2026年6月最新】デイジークリニックとトゥルーデザインクリニックを10項目で徹底比較。眉・リップ・アイラインの料金、施術方式、店舗数、大阪・心斎橋でのアクセスまで。価格重視で大阪ならトゥルーデザイン、全国展開・通常価格メニューならデイジー。",
  keywords:
...
const comparisonItems = [
  ...
  },
  {
    ...
    winner: "dazzy",
    detail:
      "デイジーは新宿本院・札幌・福岡天神・大阪心斎橋の全国4院を展開しており、東京・北海道・九州・関西の広いエリアをカバーしています。トゥルーデザインは大阪・心斎橋の1院のみのため、関西圏以外の方にはデイジーが現実的な選択肢になります。",
  },
  {
    label: "大阪でのアクセス",
    dazzy: "大阪心斎橋院あり",
