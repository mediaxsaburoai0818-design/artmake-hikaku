...
const comparisonItems = [
  ...
  },
  {
    ...
    winner: "creage",
    detail:
      "クレアージュは東京・大阪・名古屋・福岡・札幌の全国5院、デイジーは新宿本院・札幌・福岡天神・大阪心斎橋の4院を展開しています。院数ではクレアージュがやや多く、特に名古屋エリアで通うならクレアージュ一択です。新宿・心斎橋など繁華街でのアクセスを重視するならデイジーも便利です。",
  },
  {
    label: "モニター制度",
    creage: "眉モニター（全顔）あり\n札幌/大阪/福岡105,600円\n名古屋92,400円",
...
const faqs = [
  ...
  },
  {
    ...
    a: "クレアージュは東京・大阪・名古屋・福岡・札幌の全国5院、デイジーは新宿本院・札幌・福岡天神・大阪心斎橋の4院です。名古屋ならクレアージュのみ、新宿・心斎橋の繁華街アクセス重視ならデイジーが便利です。どちらも札幌・福岡・大阪エリアをカバーしています。",
  },
  {
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="bg-gradient-to-br from-rose-50 to-pink-50 border-2 border-rose-300 rounded-2xl p-8">
              ...
              <p className="mt-6 text-xs text-gray-500 bg-white rounded-lg p-3">
                通院回数を抑えて早く完成させたい方、リップやアイライン下も入れたい方、新宿・心斎橋で受けたい方に最適
              </p>
            </div>
          </div>
        </div>
